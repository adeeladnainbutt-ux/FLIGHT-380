    ...
    <header className="fixed top-0 w-full bg-white/90 backdrop-blur-md shadow-sm z-50">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <a href="#home" className="flex items-center gap-2 group">
          ...
          <span className="text-xl font-bold bg-gradient-to-r from-brand-700 to-brand-700 bg-clip-text text-transparent">
            Flight380
          </span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Button className="bg-gradient-to-r from-brand-600 to-brand-600 hover:from-brand-700 hover:to-brand-700 font-semibold">
            Sign Up
          </Button>
        </div>
          ...
          <SheetContent side="right" className="w-[300px] sm:w-[400px]">
            <nav className="flex flex-col gap-4 mt-8">
              ...
              <div className="flex flex-col gap-3 mt-6">
                ...
                <Button className="w-full bg-gradient-to-r from-brand-600 to-brand-600 hover:from-brand-700 hover:to-brand-700 font-semibold">
                  Sign Up
                </Button>
              </div>
            </nav>
